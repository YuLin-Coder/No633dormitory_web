    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">修改宿管</div>
          <div class="layui-card-body">
             <form action="UserServlet?action=updateUser" method="post" id="registerForm" name="registerForm" enctype="multipart/form-data" class="layui-form" >
              <input name="username" id="username" value="${user.username }" type="hidden" class="layui-input" /> 
              <div class="layui-form-item">
                <label class="layui-form-label">姓名:</label>
                <div class="layui-input-inline">
				<input name="name" id="name" value="${user.name }"  class="layui-input" /> 
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<textarea style="width:300px;height:100px" name="floor" id="floor" class="layui-input" >${user.floor }</textarea> 
                </div>
              </div>
              ...
              <br>
                ...
                <div class="layui-input-block">
                  ...
                  <c:if test="${flag == 2 }">
                     <a href="UserServlet?action=toUpdateUser&uid=${user.id }" class="layui-btn layui-btn-primary" >重置</a>
                  </c:if>
