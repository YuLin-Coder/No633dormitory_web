    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">宿管信息</div>
             ...
             <form action="" method="post" id="registerForm" name="registerForm" enctype="multipart/form-data" class="layui-form" >
              ...
              <div class="layui-form-item">
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="sex" id="sex" value="${user.sex }" class="layui-input" /> 
                </div>
              </div>
                ...
                <div class="layui-form-item">
                   <label class="layui-form-label">头像展示:</label>
                    <div class="layui-input-inline">
                     	<img src="<%=path %>${user.tx}" id="preview_img" width="350px" height="200px" alt="">
                    </div>
               </div> 
