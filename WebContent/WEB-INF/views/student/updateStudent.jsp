    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">修改学生</div>
          <div class="layui-card-body">
             <form action="StudentServlet?action=updateStudent" method="post" id="registerForm" name="registerForm" enctype="multipart/form-data" class="layui-form" >
              ...
              <div class="layui-form-item">
               ...
               <div class="layui-form-item">
	               <label class="layui-form-label">宿舍:</label>
	                <div class="layui-input-inline">
	                    <select name="d_id" id ="d_id" style="width:13%;height:38px">
	                    <c:forEach items="${dormitoryList}" var="u">
						     <c:if test="${u.id == student.d_id }">
					         <option value="${u.id}" selected>${u.floor}</option>
				        </c:if>
				       <c:if test="${u.id != student.d_id }">
              ...
              <br>
                ...
                <div class="layui-input-block">
                  ...
                  <c:if test="${flag == 1 }">
                    <a href="StudentServlet?action=studentList" class="layui-btn layui-btn-primary" >返回</a>
                  </c:if>
                  <c:if test="${flag == 2 }">
                     <a href="StudentServlet?action=toUpdateStudent&stuno=${student.stuno }" class="layui-btn layui-btn-primary" >重置</a>
                  </c:if>
