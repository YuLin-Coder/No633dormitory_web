    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">新增学生</div>
          <div class="layui-card-body">
             <form action="StudentServlet?action=addStudent" method="post" id="registerForm" name="registerForm" enctype="multipart/form-data" class="layui-form" >
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="stuno" id="stuno" class="layui-input" /> 
                </div>
              </div>
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="major" id="major" class="layui-input" /> 
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="bj" id="bj" class="layui-input" /> 
                </div>
              </div>
              ...
              <br>
                ...
                <div class="layui-input-block">
                  ...
                  <a href="StudentServlet?action=toAddStudent" class="layui-btn layui-btn-primary" >重置</a>
                </div>
              </div>  
              </form>
            </div>
