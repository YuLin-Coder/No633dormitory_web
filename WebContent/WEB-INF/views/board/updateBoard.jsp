      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body">
             <form action="BoardServlet?action=updateBoard" method="post" id="registerForm" name="registerForm" >
             	 <input name="bid" id="bid" value="${board.id }" type="hidden" /> 
              <div class="layui-form-item">
               ...
               <div class="layui-form-item" >
                ...
                <div class="layui-input-inline">
                      <textarea name="content" id="content"  placeholder="请输入内容" class="layui-textarea">${board.content }</textarea>
                </div>
                </div>
