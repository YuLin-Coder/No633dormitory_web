    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">新增卫生考核</div>
          <div class="layui-card-body">
             <form action="WskhServlet?action=addWskh" method="post" id="registerForm" name="registerForm"  class="layui-form" >
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="score" id="score" class="layui-input" /> 
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
				<input name="jlr" id="jlr" value="${user.name }" class="layui-input" /> 
                </div>
              </div>
              ...
              <br>
                ...
                <div class="layui-input-block">
                  ...
                  <a href="WskhServlet?action=wskhList" class="layui-btn layui-btn-primary" >返回</a>
                </div>
              </div>  
              </form>
            </div>
